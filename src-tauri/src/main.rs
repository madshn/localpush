...
fn main() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_source_status_counts,
            ...
            commands::reauth_google_sheets_target,
            ...
            commands::get_source_window_setting,
            commands::set_source_window_days,
