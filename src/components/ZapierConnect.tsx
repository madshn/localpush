  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      <div>
        ...
        />
        <div className="text-[11px] text-text-secondary mt-1">A friendly name for this webhook</div>
      </div>
      ...
      <div>
        ...
        <div className="text-[11px] text-text-secondary mt-1">
          Create a Zap with &quot;Webhooks by Zapier&quot; → &quot;Catch Hook&quot;, then paste the
          URL here
        </div>
      </div>
      ...
      <div className="flex gap-2.5 p-3 bg-accent/10 border border-accent/20 rounded-md">
        ...
        <p className="text-[11px] text-text-secondary leading-relaxed">
          The webhook URL is self-authenticating. Only share it with trusted systems. LocalPush will
          send JSON payloads to this endpoint.
        </p>
      </div>
